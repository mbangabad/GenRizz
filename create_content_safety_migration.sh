...
# Create a new migration with the needed tables
...
# Push migration to the linked Supabase project (uses supabase/config.toml or env)
supabase db push

echo "✅ Supabase migration pushed. Next:"
echo "  - Seed whitelist rows if desired:"
...
echo "  - Seed Spotlight/Daily Drop rows via SQL editor or similar."