  ...
  const stats = [
    {
      ...
      label: 'Day Streak',
      color: '#FF6B35',
      bgGradient: 'from-[#FF6B35]/20 to-[#FF4B4B]/20',
      animate: streak > 0,
    },
    {
      icon: Zap,
      ...
      label: 'Total XP',
      color: '#00CED1',
      bgGradient: 'from-[#00CED1]/20 to-[#64FFDA]/20',
    },
    {
      icon: Trophy,
      value: gamesPlayed || 0,
      label: 'Games',
      color: '#FFE066',
      bgGradient: 'from-[#FFE066]/20 to-[#FFB347]/20',
    },
    {
      icon: Target,
      ...
      label: 'Avg Score',
      color: '#4ADE80',
      bgGradient: 'from-[#4ADE80]/20 to-[#64FFDA]/20',
    },
  ];
