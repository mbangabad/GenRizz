...
// Lazy-load heavy routes to reduce bundle size
const Gameplay = lazy(() => import("./Gameplay"));
const PersonalityGameplay = lazy(() => import("./PersonalityGameplay"));
const OpinionGameplay = lazy(() => import("./OpinionGameplay"));
...
const StatsDeepDive = lazy(() => import("./StatsDeepDive"));
